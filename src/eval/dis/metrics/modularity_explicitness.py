...
at: https://github.com/zhuxinqimac/CommutativeLieGroupVAE-Pytorch/blob/main/metrics/modularity_explicitness.py
...
class Modularity:
    ...
    def __call__(self, model):
        scores = {}
        mus_train, ys_train = utils.sample_batch(model.rep_fn, self.num_points, self.ds)
